...
public:
  ...
  float spaceship(int num, float palette[4][4], float spread, int minxyScale, int maxxyScale, int minzScale, int maxzScale, bool draw, int mask);
